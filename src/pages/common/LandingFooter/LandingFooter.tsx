          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                ...
                <span className="text-gray-600 text-sm">01234 567 890</span>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <span className="text-gray-600 text-sm break-all">info@loremipsum.co.uk</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-[#FF9100]"
              />
              <button className="px-4 py-2 text-sm bg-[#FF9100] text-white rounded-lg hover:bg-[#E07B00] transition">
                Subscribe
              </button>
            </div>
