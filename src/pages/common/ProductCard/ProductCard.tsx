    ...
    return (
        <div className="group relative flex flex-col bg-white rounded-[20px] p-3 border border-slate-100 h-full overflow-hidden transition-all duration-500 ease-out hover:bg-emerald-50/30 hover:border-emerald-200 hover:shadow-[0_20px_40px_-15px_rgba(16,185,129,0.15)]">
            ...
            <div className="flex flex-col pt-3 pb-1 px-1 flex-grow">
                ...
                {/* 3. EQUAL WIDTH BUTTONS (Fully Responsive) */}
                <div className="mt-auto flex items-center gap-2 w-full pt-1">
                    
                    {/* Add to Cart Button */}
                    <button
                        onClick={(e) => {
                            e.preventDefault(); // Prevents accidental navigation if wrapped
                            onAddToCart?.(product);
                        }}
                    ...
                    >
                        ...
                        {/* Hidden on ultra-tiny screens, visible on normal mobile and up */}
                        <span className="font-bold text-[11px] sm:text-[11px] whitespace-nowrap">
                            Add to Cart
                        </span>
                    </button>
                    ...
                    <Link
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 h-10 sm:h-11 rounded-xl border-2 border-slate-100 bg-white text-slate-600 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700 transition-all active:scale-95"
                    >
                        <Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 opacity-70" />
                        <span className="font-bold text-[11px] sm:text-[11px] whitespace-nowrap">
                            Details
                        </span>
                    </Link>
