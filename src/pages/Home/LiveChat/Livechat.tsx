...
export default function LiveChat() {
    ...
    return (
        <>
            ...
            <div className="fixed top-[60%]  md:top-[55%] -translate-y-1/2 right-0 z-40 h-auto rounded-l-full bg-white px-2  Py-3 shadow-lg hover:bg-gray-100 border-2 border-primary-light">
                <button
